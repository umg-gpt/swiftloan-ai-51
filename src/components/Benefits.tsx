...
const Benefits: React.FC = () => {
  ...
  return (
    <section 
      id="benefits" 
      ref={sectionRef}
      className="py-24 px-6 md:px-10 bg-gradient-to-b from-white to-refresh-50"
    >
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row gap-16">
          <div className="md:w-1/2">
            <div className="sticky top-32">
              <div className="inline-flex items-center bg-white rounded-full px-3 py-1 mb-5 border border-refresh-100">
                <span className="text-refresh-700 text-sm font-medium">Real World Impact</span>
              </div>
              <h2 className="text-3xl md:text-4xl font-bold mb-6">
                Transform Your Lending with Measurable Results
              </h2>
              <p className="text-gray-600 mb-8 text-lg">
                Refresh doesn't just promise efficiency—we deliver quantifiable benefits that transform how Indian banks approach home loan underwriting.
              </p>
              
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="flex-shrink-0 rounded-full bg-refresh-100 p-1 mr-4">
                    <ArrowRight className="h-5 w-5 text-refresh-600" />
                  </div>
                  <div>
            ...
            <div className="grid grid-cols-1 gap-8">
              <div className="glass-card rounded-2xl p-8 card-hover-effect">
                ...
                <div className="flex items-baseline mb-1">
                  <h3 className="text-5xl font-bold text-refresh-700">
